...
> **Viajes es la única colección sin baja lógica.** El §11.5 establece que
...
| Módulos: clientes, vehículos, operadores, rutas, viajes | Completo |
| Módulos restantes (3): entregas, combustible, mantenimiento | Pendiente |
